  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="text-center p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Chatbot Error</h1>
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          We apologize for the inconvenience. An error has occurred with the AI chatbot.
        </p>
